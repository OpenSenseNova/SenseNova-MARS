...
"""
Image Crop Tool for VLM multi-turn training.
...
- image_index parameter to select which image to crop from conversation
...
class ImageCropTool(BaseTool):
    ...
    def __init__(self, config: dict, tool_schema: OpenAIFunctionToolSchema):
        ...
        logger.info(
            f"Initialized ImageCropTool: mode={self.image_crop_mode}, "
    ...
    async def create(self, instance_id: Optional[str] = None, **kwargs) -> tuple[str, ToolResponse]:
        ...
        Args:
            ...
            **kwargs: Should contain 'images' key with list of images available for cropping
    ...
    async def execute(
        ...
        Args:
            ...
            parameters: Tool parameters including:
                ...
                - img_idx or image_index: 0-based index of image to crop (default: 0)
        ...
        if not images:
            return (
                ToolResponse(text="Error: No images available for cropping."),
                -0.05,
