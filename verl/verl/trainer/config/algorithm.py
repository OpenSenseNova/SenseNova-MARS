...
class AlgoConfig(BaseConfig):
    ...
    Args:
        ...
        apply_batch_norm (bool): ReBN - apply batch-level z-score normalization after group normalization.
    ...
    apply_batch_norm: bool = False  # ReBN: apply batch-level z-score normalization after group normalization
    normalization_level: str = "token"  # "token" (default) or "sequence" - controls aggregation level for REINFORCE++
