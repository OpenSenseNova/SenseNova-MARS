...
def hf_processor(name_or_path, **kwargs):
    ...
    # Configure image_processor pixel limits from env vars (matching vision_utils.py)
    # This ensures processor's resize produces same dimensions as process_image(),
    ...
    if processor is not None and hasattr(processor, 'image_processor'):
        ...
        if hasattr(image_processor, 'min_pixels'):
            image_processor.min_pixels = int(os.getenv("MIN_PIXELS", DEFAULT_MIN_PIXELS))
        if hasattr(image_processor, 'max_pixels'):
            image_processor.max_pixels = int(os.getenv("MAX_PIXELS", DEFAULT_MAX_PIXELS))
