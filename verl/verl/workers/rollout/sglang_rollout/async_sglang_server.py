...
class SGLangHttpServer:
    ...
    async def launch_server(self, master_address: str = None, master_port: int = None):
        ...
        # Only set random_seed when explicitly configured (matches original verl behavior)
        if self.config.seed is not None:
            args["random_seed"] = self.config.seed + self.replica_rank
    ...
    async def generate(
        ...
        # SGLang uses "sampling_seed" instead of "seed"
